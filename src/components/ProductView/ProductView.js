...
import { addItem } from '~/redux/cartItemsSlice/cartItemsSlice';
            ...
            <div className="product__images">
                <div className="product__images__list">
                    <div className="product__images__list__item">
                        <img src={product.image01} alt="" onMouseOver={() => setPreviewImg(product.image01)} />
                    </div>
                    <div className="product__images__list__item">
                        <img src={product.image02} alt="" onMouseOver={() => setPreviewImg(product.image02)} />
                    </div>
                </div>
            ...
            <div className="product__info">
                ...
                <div className="product__info__item">
                    <div className="product__info__item__title">
                        Màu sắc : <span className="product__info__item__title__color">{color}</span>
                    </div>
                ...
                <div className="product__info__item">
                    <div className="product__info__item__title">
                        Kích cỡ : <span className="product__info__item__title__color">{size}</span>
                    </div>
                    <div className="product__info__item__list">
